  ...
  public class HomeController : Controller
  {
    ...
    public IActionResult CheckLogin(string name, int cardnum)
    {
      ...
      using (Team23LibraryContext db = new Team23LibraryContext())
      {
        ...
        //System.Diagnostics.Debug.WriteLine("===== LOGIN PASS/FAIL IS... =====");
        foreach (var v in query)
        {
          if (v.Name.Equals(name) && v.CardNum == cardnum)
            loginSuccessful = true;
        }
        //System.Diagnostics.Debug.WriteLine(loginSuccessful.ToString());
