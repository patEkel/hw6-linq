...
{
    public partial class Team23LibraryContext : DbContext
    {
        public Team23LibraryContext()
        {
        }

        public Team23LibraryContext(DbContextOptions<Team23LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u0736878;Password=password;Database=Team23Library");
            }
        }
